...
ERROR_FIFO = 5 30 10 5 10 3 5 fifo
...
# 	@./$(NAME) $(VALID_EDF)
# 	@echo "=== 3. big fifo (doit passer) ==="
# 	@./$(NAME) $(BIG_TEST_FIFO)
# 	@echo "=== 4. big edf (doit passer) ==="
# 	@./$(NAME) $(BIG_TEST_EDF)
# 	@echo "=== 5. error (ne doit pas passer) ==="
# 	@./$(NAME) $(ERROR_FIFO)
	@echo "=== 6. one_coder (ne doit pas passer) ==="
	@./$(NAME) $(ONE_CODER)
